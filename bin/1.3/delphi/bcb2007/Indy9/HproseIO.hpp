...
// (DO NOT EDIT: machine generated header) 'Hproseio.pas' rev: 11.00
...
public:
	...
	WideChar __fastcall ReadUTF8Char(bool IncludeTag = true);
...
public:
	...
	void __fastcall WriteUTF8Char(WideChar C);
...
public:
	...
	/*         class method */ static AnsiString __fastcall Serialize(TMetaClass* vmt, System::TVarRec const * Value, const int Value_Size)/* overload */;
...
extern PACKAGE AnsiString __fastcall HproseSerialize(System::TVarRec const * Value, const int Value_Size)/* overload */;
