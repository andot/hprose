...
// (DO NOT EDIT: machine generated header) 'Hproseio.pas' rev: 20.00
...
private:
	...
	System::Variant __fastcall ReadRef();
...
public:
	...
	System::Variant __fastcall ReadNull();
	System::Variant __fastcall ReadEmpty();
