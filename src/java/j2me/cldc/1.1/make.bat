...
javac -g:none -source 1.2 -target 1.2 -bootclasspath "%JavaME_PATH%\lib\cldc_1.1.jar";"%JavaME_PATH%\lib\midp_1.0.jar" -d build src\hprose\common\*.java src\hprose\io\*.java src\hprose\client\*.java
